...
public class applistAdapter extends ArrayAdapter<String> {
    ...
    public applistAdapter(@NonNull  Activity context1, String[] mainTitle, String[] description, Integer[] imgss) {
        super(context1, R.layout.apprecent,mainTitle);
    ...
    public View getView(int position,View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.apprecent,null,true);
