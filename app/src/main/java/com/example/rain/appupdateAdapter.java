...
public class appupdateAdapter extends ArrayAdapter<String> {
    ...
    public appupdateAdapter(@NonNull  Activity context1, String[] mainTitle, String[] description, Integer[] img, Integer[] down, Integer[] button) {
    ...
    public View getView(int position,View view, ViewGroup parent) {
        ...
        ImageView imageView2 = rowView.findViewById(R.id.button);
